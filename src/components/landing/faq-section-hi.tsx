...
const faqs = [
    ...
    },
    {
        ...
        answer: "सदस्यों को दुर्घटनाओं के मामले में वित्तीय सहायता, मजदूरी विवादों के लिए कानूनी मदद, मान्यता के लिए एक आधिकारिक संघ आईडी, और साथी श्रमिकों के एक सहायक समुदाय का हिस्सा बनने का अवसर मिलता है। अधिक जानकारी के लिए, कृपया हमारे "
    },
    {
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  <AccordionContent className="text-base text-gray-600 leading-relaxed pb-4">
                    {faq.answer}
                     {faq.question === "एक सदस्य के रूप में मुझे क्या लाभ मिलते हैं?" && (
                        <Link href="/hi/terms-and-conditions" className="text-primary hover:underline">नियम और शर्तें देखें।</Link>
                    )}
                  </AccordionContent>
                </AccordionItem>
              ))}
