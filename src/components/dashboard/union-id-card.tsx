...
export function UnionIdCard() {
    ...
    return (
        <Card className="w-full max-w-md mx-auto shadow-lg overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
            <CardContent className="p-0">
                <div className="p-5 bg-primary text-primary-foreground flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-bold text-lg">Telangana Building Workers Union</h3>
                            <p className="text-xs opacity-90">Official Member ID</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-5">
                        ...
                        <div className="space-y-2 text-center sm:text-left">
                            ...
                            <div className="flex items-center gap-2 justify-center sm:justify-start">
                                ...
                                <span className="font-mono text-sm text-muted-foreground">{userData.unionId || 'ID Pending'}</span>
                            </div>
                            <div className="flex items-center gap-2 justify-center sm:justify-start">
