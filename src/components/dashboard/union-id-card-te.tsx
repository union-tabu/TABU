    ...
    const onDownload = useCallback(() => {
        ...
        toJpeg(idCardRef.current, { cacheBust: true, quality: 0.95, backgroundColor: 'white' })
            .then((dataUrl) => {
                ...
                link.click();
                 toast({
                    title: "ID కార్డ్ డౌన్‌లోడ్ చేయబడింది",
                    description: "మీ ID కార్డ్ విజయవంతంగా సేవ్ చేయబడింది.",
                });
            })
            .catch((err) => {
                console.error(err);
                 toast({
                    title: "డౌన్‌లోడ్ విఫలమైంది",
                    description: "ID కార్డ్‌ను డౌన్‌లోడ్ చేయడంలో సమస్య ఉంది. దయచేసి మళ్లీ ప్రయత్నించండి.",
                    variant: "destructive"
                });
            });
