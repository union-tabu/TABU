...
// 1. మీ ఫైర్‌బేస్ కన్సోల్‌కు వెళ్లండి: https://console.firebase.google.com/
// 2. మీ ప్రాజెక్ట్‌ను ఎంచుకోండి.
// 3. "Authentication" -> "Settings" -> "Authorized domains"కు వెళ్లండి.
// 4. "Add domain" క్లిక్ చేయండి.
// 5. మీరు పరీక్షిస్తున్న డొమైన్‌ను జోడించండి. స్థానిక అభివృద్ధి కోసం, ఇది `localhost`.
//    మీరు ప్రివ్యూ URL ఉపయోగిస్తుంటే, ఆ నిర్దిష్ట URLను జోడించాలి.
// =================================================================================
