...
export function CashfreeAnnualButton() {
  return (
    <>
      <style>
        {`
      ...
      <Link href="https://payments.cashfree.com/forms/annual-plan" target="_parent" className="cf-link">
        <div className="button-container">
          <div>
            <img src="https://cashfree-checkoutcartimages-prod.cashfree.com/tabu-logo-websiteo99ghnsn9qng_prod.png" alt="logo" className="logo-container" />
          </div>
